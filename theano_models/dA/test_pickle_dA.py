...
class test_pickle_dA(TestCase):
    ...
    def test_pickled_dA(learning_rate=0.1,
                ...
                batch_size=20):
        """
            Test pickling, unpickling code for the dA class.  
        ...
        self.assertAlmostEqual(dA_params[0].get_value(), pickled_params[0].get_value())
        self.assertAlmostEqual(dA_params[1].get_value(), pickled_params[1].get_value())
        self.assertAlmostEqual(dA_params[2].get_value(), pickled_params[2].get_value())
