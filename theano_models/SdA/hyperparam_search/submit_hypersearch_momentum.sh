...
cd $PBS_O_WORKDIR
python hyperparam_multiproc.py -d "${SCRATCH}/gpu_models/SdA/hyper_opt/2013-06-21" -s momentum -a $FIRSTMODEL -b $SECONDMODEL -i "${SCRATCH}/sm_rep1_data/sm_rep1_screen.h5" -o $OFFSET
