...
cd $PBS_O_WORKDIR
python hyperparam_multiproc.py -d "${SCRATCH}/gpu_models/SdA/hyper_opt/" -s corruption -a $FIRSTMODEL -b $SECONDMODEL -i "${SCRATCH}/sm_rep1_data/sm_rep1_screen.h5" -o $OFFSET
