...
cd $PBS_O_WORKDIR
python ../pretrain_SdA_multiproc.py -d "${SCRATCH}/gpu_tests/SdA_results/5_layers/pretrained/$OUTDIRSUFFIX" -c 0.10 -a $FIRSTMODEL -b $SECONDMODEL -i "${SCRATCH}/sm_rep1_data/sm_rep1_screen.h5" -o $OFFSET
