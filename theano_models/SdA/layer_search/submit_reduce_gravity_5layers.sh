...
cd $PBS_O_WORKDIR
python ../reduce_SdA_multiproc.py -d "${SCRATCH}/gpu_tests/SdA_results/5_layers/reduced_data" -x $EXTENSION -p $FIRSTMODEL -q $SECONDMODEL -i "${SCRATCH}/sm_rep1_data/sample.h5" 
