...
#PBS -N FineTuneStackedAutoencoder$FIRSTMODEL|$SECONDMODEL
#PBS -q gravity
...
cd $PBS_O_WORKDIR
python ../finetune_SdA_multiproc.py -d "${SCRATCH}/gpu_tests/SdA_results/3_layers/finetune_output" -e "40" -x "40" -p $FIRSTMODEL -q $SECONDMODEL -i "${SCRATCH}/sm_rep1_data/sm_rep1_screen.h5" -o $OFFSET
