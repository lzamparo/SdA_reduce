...
cd $PBS_O_WORKDIR
python finetune_SdA_multiproc.py -d "${SCRATCH}/gpu_models/SdA/finetune_output" -e "10" -x "10" -p $FIRSTMODEL -q $SECONDMODEL -i "${SCRATCH}/sm_rep1_data/sm_rep1_screen.h5" -o $OFFSET
