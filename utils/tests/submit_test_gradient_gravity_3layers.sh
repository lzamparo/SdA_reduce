...
#PBS -N TestGradientStackedAutoencoder
#PBS -q gravity
...
cd $PBS_O_WORKDIR
python test_gradient.py -d "${SCRATCH}/gpu_tests/SdA_results/3_layers/finetune_output" -e "10/relu" -x "10/relu" -p $FIRSTMODEL -q $SECONDMODEL -i "${SCRATCH}/sm_rep1_data/sm_rep1_screen.h5" -o $OFFSET
